...
<!--                                                <li class="nav-item Navbar">
        ...
        <li class="nav-item Navbar">
         <a class="nav-link" href="../foodDrink/index.php" role="button"  aria-haspopup="true" aria-expanded="false">
        Food/Drink<span class="caret"></span></a></li>
                                                <li class="nav-item Navbar">
                                    <a class="nav-link" href="../extraService/index.php" role="button"  aria-haspopup="true" aria-expanded="false">
                                    Extra Services<span class="caret"></span></a>
</li>    
                                                        <li class="nav-item Navbar">
                                    <a class="nav-link" href="../categoryfd/index.php" role="button"  aria-haspopup="true" aria-expanded="false">
                                    Category Food/Drink<span class="caret"></span></a>
</li>
        <li class="nav-item Navbar">
         <a class="nav-link" href="../maintenance/index.php" role="button"  aria-haspopup="true" aria-expanded="false">
        Maintenance<span class="caret"></span></a></li>
<li class="nav-item Navbar">
         <a class="nav-link" href="../bathe/index.php" role="button"  aria-haspopup="true" aria-expanded="false">
        Bathes<span class="caret"></span></a></li>
        <li class="nav-item Navbar">
            
         <a class="nav-link" href="../customer/index.php" role="button"  aria-haspopup="true" aria-expanded="false">
        Customers<span class="caret"></span></a></li>
                        <li class="nav-item Navbar">
                                    <a class="nav-link" href="../room/index.php" role="button"  aria-haspopup="true" aria-expanded="false">
                                    Rooms<span class="caret"></span></a>
</li>
                        <li class="nav-item Navbar">
                                    <a class="nav-link" href="../login/logout.php" role="button"  aria-haspopup="true" aria-expanded="false">
